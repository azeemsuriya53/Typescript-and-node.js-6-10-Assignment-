...
let favouriteNumber = 17;
console.log(`My Favourite Color is ${favouriteNumber} because it's my Birthday date.`);
////////// task 10
...
let favouriteNumber = 17;
// reveiling my favourite number in a message format:
console.log(`My Favourite Color is ${favouriteNumber} because it's my Birthday date.`);
